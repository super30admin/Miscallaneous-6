...
// Sort the array
// Traverse nums and if the threshold is greater than the number we increase the threshold 
// by the difference distributed equally among the greater elements.
import java.io.*;
